...
const button = ({ element, child, variant = 'contained' }) => {
  if (variant === 'link') {
    return El({
      ...
      className: `${varients[variant]} w-18 hidden xl:flex items-center text-gray-400 text-sm hover:text-gray-800 hover:bg-gray-100 px-3 py-2 h-10 rounded-md font-bold text-md mr-4`,
